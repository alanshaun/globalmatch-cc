...
function NegotiateTab({ buyer }: { buyer: BuyerResult }) {
  ...
  return (
    <div className="p-5 space-y-5">
      ...
      {/* Mock negotiate CTA */}
      <div className="pt-1">
        <button className="w-full py-3 rounded-xl text-sm font-semibold bg-gradient-to-r from-primary to-blue-500 text-white shadow-md shadow-primary/20 hover:opacity-90 active:scale-[0.98] transition-all">
          ⚔ 开始 AI 模拟谈判（即将上线）
        </button>
        <p className="text-xs text-slate-400 text-center mt-2">Pro 功能 · 模拟对话，找到最优报价策略</p>
      </div>
    </div>
  );
}
          ...
          {sent ? (
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-3 rounded-xl text-sm font-semibold bg-gradient-to-r from-primary to-blue-500 text-white hover:opacity-90 active:scale-[0.98] transition-all shadow-sm"
              >
                ⚔ 模拟谈判
              </button>
            </div>
